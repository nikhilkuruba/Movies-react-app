...
const Signin=()=>{
    ...
    const Verify = async(e)=>{
        ...
        if(parseInt(data) === true){
            phone = data
            axios.post("https://movies-app-237.herokuapp.com/",{phone,password},
            {
            ...
            email = data
            axios.post("https://movies-app-237.herokuapp.com/",{email,password},{
                headers:{
                ...
                if(res.status === 200){
                    ...
                    localStorage.setItem('token',token)
                    localStorage.setItem('user',userData)
                    window.location.href = "discover/popular";
                }
            }).catch((e)=>{
                alert("Login Failed");
            })
    ...
    return(
        <div className='p3-signin-component'>
            ...
            <form className='p3-signin-forms' onSubmit={Verify} >
                ...
                <p className='p3-form-name'>Email</p>
