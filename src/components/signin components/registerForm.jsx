...
function RegisterForm(){
  ...
  const[user,setuser]=useState({name:"", email:"", password:"", phone:"", country:""});
  ...
  const Postdata=async (e)=>{
    ...
    const res=await fetch("https://movies-app-237.herokuapp.com/register",{
      method:"POST",
      headers:{
    ...
    return (<div className='register-component'>
            ...
            <form className='register-forms' method="POST">
                ...
                <div className="one-form">
                <p className='register-name'>Country</p>
